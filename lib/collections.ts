...
export const collections: Collection[] = [
  {
    ...
    // Aerial night plate: tiny boat upper-right, searchlight down-left
    // over a colossal alien-scale submerged silhouette. The WebGPU hero
    // samples this still and refracts the painted beam with live waves.
    heroImage: {
      src: "/collections/malum/hero/malum-hero-night.webp",
      alt: "MALUM Collection | Aerial night sea, a small boat over a colossal submerged shadow",
      width: 1536,
      height: 1024,
    },
    heroImagePosition: "82% 20%",
